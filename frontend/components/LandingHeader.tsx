  ...
  return (
    <header className="fixed top-0 w-full z-50 backdrop-blur-md bg-white/40 border-b border-white/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <Link
          href="/"
          className="text-2xl sm:text-3xl font-dancing font-bold bg-gradient-to-r from-pink to-purple bg-clip-text text-transparent hover:scale-105 transition"
        >
          Gina Ballerina
        </Link>
        ...
        <div className="hidden sm:flex items-center gap-6">
          <Link href="/about" className="text-gray-700 hover:text-pink transition font-medium">
            About Us
          </Link>
          <Link href="/contact" className="text-gray-700 hover:text-pink transition font-medium">
            Contact
          </Link>
          <Link
            href="/shop"
      ...
      {isOpen && (
        <div className="sm:hidden bg-white/90 backdrop-blur-md border-b border-pink/20 px-4 py-4 flex flex-col gap-3">
          <Link href="/about" className="text-gray-700 hover:text-pink py-1" onClick={() => setIsOpen(false)}>
            About Us
          </Link>
          <Link href="/contact" className="text-gray-700 hover:text-pink py-1" onClick={() => setIsOpen(false)}>
            Contact
          </Link>
          <Link
            href="/shop"
